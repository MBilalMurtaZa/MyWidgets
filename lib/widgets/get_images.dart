...
class GetImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: onTap??(Static.defaultImageClick?(){
        pSetRout(page: ()=> FullPhotoView(images: [imagePath??defaultImage], isAsset: isAsset,));
      }:null),
      child: ClipRRect(
        ...
        SizedBox(
          ...
          child: Image.asset(imagePath??defaultImage, color: imageColor, width: width, height: height, fit: fit,),
        )
            :
        CachedNetworkImage(
