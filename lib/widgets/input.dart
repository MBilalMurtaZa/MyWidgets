...
class TxtFormInput<T> extends StatefulWidget {
  ...
  final Widget? postFix, preFix, postFixErrorIcon;
  final InputDecoration? decoration;
  final FormFieldValidator<String>? validator;
  final GlobalKey<FormState>? formKey;
  final EdgeInsetsGeometry? contentPadding;
  final Color? fillColor, borderColor, cursorColor;
  final bool showPostFixErrorIcon;
  final TextStyle? labelStyle, hintStyle, style, prefixStyle, postFixStyle, errorStyle;
  ...
  const TxtFormInput({
    ...
    this.postFix,
    this.preFix,
    this.postFixErrorIcon,
    this.showPostFixErrorIcon = true,
    this.postFixStyle,
    this.decoration,
    this.validator,
    this.formKey,
        ...
        IgnorePointer(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                height: widget.height == null && Static.txtInputHeight == null
                    ? null
                    : hasError
                        ? (widget.height ?? Static.txtInputHeight)! +
                            widget.errorHeight
                        : (widget.height ?? Static.txtInputHeight),
                child: Theme(
                  data: ThemeData(
                  ...
                  child: TextFormField(
                    ...
                    decoration: widget.decoration ??
                        ...
                        InputDecoration(
                          ...
                          suffixIcon: hasError && widget.showPostFixErrorIcon &&
                                  (Static.txtInputPostFixErrorIcon != null ||
                                      widget.postFixErrorIcon != null)
                              ? (widget.postFixErrorIcon ??
                                  Static.txtInputPostFixErrorIcon)
                              : widget.postFix,
                          ...
                          errorStyle: widget.errorStyle ?? Static.txtInputErrorStyle,
                        ),
